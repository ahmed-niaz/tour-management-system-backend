...
if (
  ...
  console.warn(
    "⚠️ Google OAuth environment variables missing: please set GOOGLE_CLIENT_ID, GOOGLE_CLIENT_SECRET, and GOOGLE_CALLBACK_URL if you intend to use Google Login.",
  );
} else {
  passport.use(
    new GoogleStrategy(
